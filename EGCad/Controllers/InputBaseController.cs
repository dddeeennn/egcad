...
namespace EGCad.Controllers
{
	...
	public abstract class InputBaseController : ApiController
	{
		...
		protected double XMin
		{
			get
			{
				return Map != null ? Map.StartT.X : 0;
			}
		}
		...
		//        {
		//            new ParameterTableEntry(0,0,0,GetParameters(1,6,0,3,1)),
		//            new ParameterTableEntry(1,0,0,GetParameters(2,2,2,2,2)),
		//            new ParameterTableEntry(2,0,0,GetParameters(6,5,5,6,6)),
		//            new ParameterTableEntry(3,0,0,GetParameters(8,8,6,9,8)),
		//            new ParameterTableEntry(4,0,0,GetParameters(4,12,3,21,9)),
		//            new ParameterTableEntry(5,0,0,GetParameters(5,1,12,2,12)),
		//            new ParameterTableEntry(6,0,0,GetParameters(11,10,15,18,13))
		//        });
		//    }
		//    set { Session["Points"] = value; }
		//}
		...
		//		return new List<ParameterTableEntry>(new[]
		//		{
		//			new ParameterTableEntry(0,100,XMin,XMax,GetParameters(-1.165,2.08,20.7,0.51,16.4,0.16,1)),
		//			new ParameterTableEntry(1,120,XMin,XMax,GetParameters(-1.199,2.07,22.4,0.56,16.4,0.162,1)),
		//			new ParameterTableEntry(2,130,XMin,XMax,GetParameters(-1.235,2.08,24.89,0.6,15.8,0.158,1)),
		//			new ParameterTableEntry(3,220,XMin,XMax,GetParameters(-1.45,2.08,25.5,0.62,14.9,0.153,0.98)),
		//			new ParameterTableEntry(4,340,XMin,XMax,GetParameters(-1.616,2.04,26.24,0.65,14,0.155,0.94)),
		//			new ParameterTableEntry(5,420,XMin,XMax,GetParameters(-1.814,2.7,27.2,0.78,12,0.18,0.87)),
		//			new ParameterTableEntry(6,520,XMin,XMax,GetParameters(-1.936,3.02,28.9,0.83,11.5,0.18,0.86)),
		//			new ParameterTableEntry(7,560,XMin,XMax,GetParameters(-2.145,2.94,31.2,0.93,11,0.2,0.79)),
		//			new ParameterTableEntry(8,620,XMin,XMax,GetParameters(-2.154,2.93,33.4,1.16,10.5,0.21,0.78)),
		//			new ParameterTableEntry(9,700,XMin,XMax,GetParameters(-2.173,2.95,36.6,1.13,10.3,0.23,0.78)),
		//			new ParameterTableEntry(10,764,XMin,XMax,GetParameters(-2.124,2.93,32.1,1.39,10,0.2,0.75)),
		//			new ParameterTableEntry(11,804,XMin,XMax,GetParameters(-2.169,2.86,37.4,1.47,10.5,0.205,0.78)),
		//			new ParameterTableEntry(12,884,XMin,XMax,GetParameters(-2.192,2.91,36.7,1.41,10.5,0.205,0.77)),
		//			new ParameterTableEntry(13,946,XMin,XMax,GetParameters(-2.166,2.9,36.3,1.54,10,0.2,0.75)),
		//			new ParameterTableEntry(14,992,XMin,XMax,GetParameters(-2.167,2.88,37.4,1.58,10,0.205,0.76)),
		//			new ParameterTableEntry(15,1030,XMin,XMax,GetParameters(-2.187,2.85,37.9,1.57,10,0.2,0.72)),
		//			new ParameterTableEntry(16,1050,XMin,XMax,GetParameters(-2.253,2.8,38.6,1.56,10.1,0.2,0.71)),
		//			new ParameterTableEntry(17,1080,XMin,XMax,GetParameters(-2.314,2.73,41.3,1.54,9.5,0.205,0.74)),
		//			new ParameterTableEntry(18,1092,XMin,XMax,GetParameters(-2.352,2.5,44.6,1.44,9.3,0.21,0.76)),
		//			new ParameterTableEntry(19,1098,XMin,XMax,GetParameters(-2.362,2.2,43.3,1.47,9.3,0.22,0.72)),
		//			new ParameterTableEntry(20,1104,XMin,XMax,GetParameters(-2.381,2,43.7,1.39,9,0.2,0.72)),
		//			new ParameterTableEntry(21,1130,XMin,XMax,GetParameters(-2.386,2.02,44.7,1.34,9.2,0.22,0.72)),
		//			new ParameterTableEntry(22,1192,XMin,XMax,GetParameters(-2.396,2.2,43.6,1.35,9.1,0.21,0.71)),
		//			new ParameterTableEntry(23,1242,XMin,XMax,GetParameters(-2.413,1.8,44.9,1.32,8.6,0.23,0.69)),
		//			new ParameterTableEntry(24,1304,XMin,XMax,GetParameters(-2.416,1.9,44.5,1.32,8.9,0.22,0.64)),
		//			new ParameterTableEntry(25,1360,XMin,XMax,GetParameters(-2.486,1.7,44.3,1.33,8.6,0.22,0.66)),
		//			new ParameterTableEntry(26,1490,XMin,XMax,GetParameters(-2.548,1.61,47.2,1.35,7.1,0.2,0.62)),
		//			new ParameterTableEntry(27,1580,XMin,XMax,GetParameters(-2.594,1.63,45.3,1.36,7.4,0.225,0.65)),
		//			new ParameterTableEntry(28,1680,XMin,XMax,GetParameters(-2.667,1.6,48.8,1.35,7,0.225,0.61))
		//		});
		//	}
		//	set { Session["Points"] = value; }
		//}
