        ...
        protected List<ParameterTableEntry> Points
        {
            get
            {
                return new List<ParameterTableEntry>(new[]
                {
                    ...
                    new ParameterTableEntry(0,0,0,GetParameters(0.64,29.79,10.81,40.89,7.02,10.85)),
                    new ParameterTableEntry(0,0,0,GetParameters(0.54,20.11,13.62,49.56,8.16,8.01)),
                    new ParameterTableEntry(0,0,0,GetParameters(0.4,15.7,11.4,54.9,9.07,8.53)),
                    new ParameterTableEntry(0,0,0,GetParameters(0.32,11.8,10.7,61.65,6.08,9.45)),
                    new ParameterTableEntry(0,0,0,GetParameters(0.25,9.81,11.01,57.78,11.8,9.35)),
                    new ParameterTableEntry(0,0,0,GetParameters(0.22,7.34,12.3,61.35,10.3,8.49)),
                    new ParameterTableEntry(0,0,0,GetParameters(0.12,5.27,4.22,68.1,11.7,10.59)),
                    new ParameterTableEntry(0,0,0,GetParameters(0.02,0.89,5.08,65.19,14.3,14.52)),
                    new ParameterTableEntry(0,0,0,GetParameters(0,0.65,2.1,32.12,42.98,22.15)),
                    new ParameterTableEntry(0,0,0,GetParameters(0,0.43,1.78,32.34,45.78,19.67)),
                    new ParameterTableEntry(0,0,0,GetParameters(0,0.21,1.59,23.78,49.87,24.55)),
                    new ParameterTableEntry(0,0,0,GetParameters(0,0.31,1.91,29.76,50.45,17.57)),
                    new ParameterTableEntry(0,0,0,GetParameters(0,0.2,1.62,21.2,49.92,27.06)),
                    new ParameterTableEntry(0,0,0,GetParameters(0,0.15,1.65,22.78,47.89,27.53)),
                    new ParameterTableEntry(0,0,0,GetParameters(0,0.1,1.6,20.3,45.24,32.76)),
                    new ParameterTableEntry(0,0,0,GetParameters(0,0.05,1.55,14.82,42.59,40.99)),
                    new ParameterTableEntry(0,0,0,GetParameters(0,0.1,1.2,12.8,41.56,44.34)),
                    new ParameterTableEntry(0,0,0,GetParameters(0,0.09,0.14,12.5,29.45,57.82)),
                    new ParameterTableEntry(0,0,0,GetParameters(0,0.05,0.34,11,32.7,55.91)),
                    new ParameterTableEntry(0,0,0,GetParameters(0,0.01,0.02,10.02,37.98,51.97)),
                    new ParameterTableEntry(0,0,0,GetParameters(0,0,0,8.68,21.81,69.51))
                });
            }
            set { Session["Points"] = value; }
        }
